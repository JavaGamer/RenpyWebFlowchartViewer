    ...
    <Tooltip.Provider>
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <div
            className={cn(
              "flex flex-wrap items-center gap-3 text-[11px]",
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              Shortcuts: Ctrl/Cmd+F search · Ctrl/Cmd+L fit · Ctrl/Cmd+E export
              PNG · Ctrl/Cmd+Z undo · Ctrl/Cmd+Y redo
            </span>
            <button
              type="button"
