            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <Dialog.Content
                className={cn(
                  ...
                  isDark ? "bg-slate-900 text-slate-100 ring-white/10" : "bg-white text-gray-900 ring-black/5",
                  className,
                )}
              >
            ...
            >
              <div
                className={cn(
                  ...
                  isDark ? "border-slate-800 bg-slate-800" : "border-gray-100 bg-gray-50/50",
                )}
              >
                <div>
                  <Dialog.Title className="text-base font-semibold">
