      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div>
            <h1
              className={cn(
                "text-base sm:text-lg font-bold tracking-tight truncate",
            ...
            <p
              className={cn(
                "hidden sm:block text-[11px] mt-0.5",
                isDark ? "text-slate-400" : "text-gray-500",
              )}
            >
              Visualize script structure, search dialogue, and export flowcharts
        ...
        <span
          className={cn(
            "sm:hidden w-full text-xs text-center py-1 border-t mt-1",
            isDark
              ? "text-slate-400 border-slate-800"
              : "text-gray-600 border-gray-100",
          )}
        >
          Upload a Ren'Py project folder to visualize script structure, search
          dialogue, and export flowcharts
        </span>
      </header>
