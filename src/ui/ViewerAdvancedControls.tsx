...
export function ViewerAdvancedControls({
  ...
  return (
    ...
    >
      ...
      {/* Section 2b: Graph Simplification */}
      <div
        className="flex flex-col gap-2"
        role="group"
        ...
        >
          <div className="flex flex-col gap-2.5">
            ...
            >
              ...
              />
              <span className={cn("font-medium", isDark ? "text-slate-350" : "text-gray-700")}>
              ...
              {simplifyInlineEmptyLabels && (
                <div className="flex items-center gap-2 pl-6 mt-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setSimplifyInlineDialogueThreshold(Math.max(1, parseInt(e.target.value) || 1))}
                    className={cn(
                      CONTROL_INPUT_CLASS,
