...
describe("Search Scoping and Filtering", () => {
  it("updates selectedSearchChapter and selectedSearchNodeKinds state", () => {
    ...
    expect(store.selectedSearchNodeKinds).toEqual({
      LABEL: true,
      MENU: true,
      DECISION: true,
    });
    ...
    store.setSelectedSearchNodeKinds({
      LABEL: true,
      MENU: false,
      DECISION: false,
    });
    ...
    expect(updated.selectedSearchNodeKinds).toEqual({
      LABEL: true,
      MENU: false,
      DECISION: false,
    });
    ...
    expect(reset.selectedSearchNodeKinds).toEqual({
      LABEL: true,
      MENU: true,
      DECISION: true,
    });
